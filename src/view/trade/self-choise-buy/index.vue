 ...
 * @FilePath: /beex/src/view/trade/self-choise-buy/index.vue
 -->
<template>
      ...
      <ul class="traders-list">
        <li v-for="(item, index) in traders " :key="index">
          ...
          <div class="pay line-wrap">
            ...
            <div class="buy-btn" @click="popupVisible = true">购买</div>
          </div>
        </li>
      </ul>
      <van-popup v-model="popupVisible" closeable>
        <div class="pay-confirm">
          <div class="goods-info line-wrap">
            <div>
              <div class="token">购买 {{ tokenList[curIdx].token }}</div>
              <div class="currency">12345678 CNY</div>
              <div class="range">限额 1000 - 12345678 CNY</div>
            </div>
          ...
          <div class="buy-input-container">
            ...
            <div class="action">
              ...
              <div class="btn-wrap line-wrap">
                ...
                <div class="buy-btn line-btn line-btn__unactive" @click="buy">下单</div>
              </div>
            </div>
          </div>
          <div class="tips">
...
.traders-list {
  ...
  .pay{
    ...
    .buy-btn{
      ...
      border-radius: 15px;
      background:linear-gradient(169deg,rgba(255,226,1,1) 0%,rgba(255,140,0,1) 100%);
    }
  }
}
.pay-confirm{
  ...
  .goods-info{
    ...
    .token{ color: #ffc100; font-size: 20px; }
